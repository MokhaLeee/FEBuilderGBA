...
//                    new Grep2PatchTableSt{ name="SkillSystems_IER", ver="FE8U", data = new byte[]{ }},
        ...
        static skill_system_enum SearchSkillSystemLow()
        {
            PatchTableSt[] table = new PatchTableSt[] { 
                ...
                new PatchTableSt{ name="CSkillSys300",	ver = "FE8U", addr = 0xB2A604,data = new byte[]{0x43, 0x53, 0x4B, 0x49, 0x4C, 0x4C, 0x53, 0x59, 0x53, 0x5F, 0x4B, 0x2D, 0x33, 0x30, 0x30, 0x00}},
            };
